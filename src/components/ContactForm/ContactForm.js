...
import { phonebookActions, phonebookOperations } from 'redux/phonebook';
...
const ContactForm = () => {
  ...
  const addContact = (name, number) => dispatch(phonebookOperations.postContacts({ name, number })); //dispatch(phonebookActions.addContact(name, number));
